...
| Tokokita 앱 MVP | 3호 가게(A)·손님(B) 등록·로그인 전환, 가게 대표 음식 사진(자동 배정), 시간대별 할인표, 예약 코드, 사장님 코드 확인·노쇼, 3교대 할인 세트, 별점, 한/인니/영 | `platforms/tokokita-app/` | v0.2 게시 (비공개) | https://claude.ai/artifact/F7uLjuAQiiX9bLKfKdUge3 |
